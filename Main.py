...
def op_menu(h, w, poz):
    if poz[0] >= h * 0.200 and poz[0] < h * 0.600 and poz[1] >= w * 0.300 and poz[1] < w * 0.350:
        return 0
    if poz[0] >= h * 0.200 and poz[0] < h * 0.600 and poz[1] >= w * 0.400 and poz[1] < w * 0.450:
        return 1
    if poz[0] >= h * 0.200 and poz[0] < h * 0.600 and poz[1] >= w * 0.500 and poz[1] < w * 0.550:
        return 2
    if poz[0] >= h * 0.200 and poz[0] < h * 0.600 and poz[1] >= w * 0.600 and poz[1] < w * 0.650:
        return 3
